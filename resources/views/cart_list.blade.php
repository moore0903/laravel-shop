        ...
        <div class="vipmain fr">
            ...
            <div class="gwckuai">
                ...
                <ul class="gwcgmlist lifl clear">
                    ...
                    <li><a href="#">去收银台结算</a></li>
                    <li class="g1"><a href="#1">清空购物清单</a></li>
                </ul>
                <div class="gwcdg"> 如果您想继续购物，请点选继续购物<br />
                    如果您想更新已在购物车内的产品，请先修改，然后点选修改数量<br />
                    如果您想删除购物车内的单一产品，请单击该产品后面的<i><img src="images/bg13.gif" /></i>图标<br />
...
@section('script')
    <script type="text/javascript">
        ...
        $('#edit_cart').on('click',function(){
            ...
            $.post("{{ url('/cart/update') }}", { set:arr, _token:_token},
                function(data){
                    if(data.stat == 1){
                        layer.msg('修改购物车成功');
                    }else{
